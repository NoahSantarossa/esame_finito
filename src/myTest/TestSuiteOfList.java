 ...
 * <li>public void myTest.TestSuiteOfList.test_RemoveAll_From1To10DuplicatesRemove345()</li>
...
public class TestSuiteOfList{
    ...
    /**
     * <p><b>Summary</b>: size method test case. 
     * The test case asserts if i have the empty list. Use doubble check with the method size() and method isEmpty()</p>
     * <p>Test Case Design: The design is a simple assert of
     * a size call and expected 0 size (empty). 
     * From Sommerville: "Test with sequences of zero lenght."</p>
     * <p>Test Description: Test based on critical case "list with zero size"</p>
    ...
    /**
     * <p><b>Summary</b>: size method test case. 
     * The test case asserts if in the list with 1000/100/10 elements the method worked</p>
     * <p>Test Case Design: The design is a simple assert of
     * a size call with a large number of data. 
     ...
     * <p>Post-Condition: The list has 1 element.</p>
     ...
     * From Sommerville: "Test software with sequences of a single value"</p>
     * <p>Test Description: Test based on the test of critical case "list with one element"</p>
     * <p>Pre-Condition: The method isEmpty() and size() worked. The list is empty.</p>
     * <p>Post-Condition: The list has 1 element.</p>
     ...
     * From Sommerville: "Test with sequences of different size."</p>
     * <p>Test Description: Test based on a specific list with 1000/100/10 elements</p>
     * <p>Pre-Condition: The method clear() and size() worked. The list is empty.</p>
     ...
     * From Sommerville: "Test software with sequences of a single value"</p>
     * <p>Test Description: Test based on the test of critical case "list with one element"</p>
     * <p>Pre-Condition: The method isEmpty() and get(index) worked. The list is empty.</p>
     * <p>Post-Condition: The list has 1 element.</p>
     ...
     * <p>Pre-Condition: The method clear(), size() and add() worked. The list is empty.</p>
     * <p>Post-Condition: The list has 10 element.</p>
     ...
     * <p>Pre-Condition: The method clear(), isEmpty() and add() worked. The list is empty.</p>
     * <p>Post-Condition: The list is empty.</p>
     * <p>Expected Results: The add(index,Object) method worked with different type of add sequences.</p>
     */
    @Test
     ...
     * <p>Pre-Condition: The list and the collection are empty. The method containsAll(Collection) and toArray() worked.</p>
     ...
     * <p>Pre-Condition: The list and the collection are empty. The method containsAll(Collection), toArray() and hashCode() worked.</p>
    ...
    /**
     * <p><b>Summary</b>: addAll method test case. 
     * The test case asserts if the method worked when collection null</p>
     ...
     * <p>Pre-Condition: The list is empty. The collection is null.</p>
     ...
     * <p>Pre-Condition: The method clear(), isEmpty() and add(Object) worked. The list is empty.</p>
     * <p>Post-Condition: The list is empty.</p>
     ...
     * <p>Pre-Condition: THe method size() worked. The list is empty.</p>
     * <p>Post-Condition: The list is empty.</p>
     ...
     * <p>Pre-Condition: The method add(Object) and isEmpty() worked. The list is empty.</p>
     ...
     * <p>Pre-Condition: The list and coll are empty.</p>
     ...
     * <p>Pre-Condition: The list is empty. The coll is null.</p>
    ...
    /**
     * <p><b>Summary</b>: containsAll method test case.
     * The method tests if an empty list contains the elements
     * of another collection.</p>
     * <p>Test Case Design: The test case tests the limit case of
     * checking an empty list.</p>
     * <p>Test Description: The collection contains 5 element.
     * The containsAll method used with list empty return false.</p>
     * <p>Pre-Condition: The method isEmpty() and add(Object) worked. The list is empty.</p>
     * <p>Post-Condition: The list is empty.</p>
     ...
     * with different collection of number.</p>
     ...
     * <p>Pre-Condition: The method add(Object) and clear() worked. The list contains numbers from 0 to 10 included.
     * coll has different configurations during tests.</p>
     * <p>Post-Condition: The list contains numbers from 0 to 10.</p>
     ...
     * The test adds one element to the list and after call
     * toArray method.</p>
     ...
     * <p>Pre-Condition: The list is empty. The method add(Object) and size() worked.</p>
     ...
     * <p>Pre-Condition: The list is empty. The method size() worked.</p>
     * <p>Post-Condition: The list is still empty.</p>
     ...
     * <p>Pre-Condition: The list is empty. The method add(Object) and clear() worked.</p>
     * <p>Post-Condition: The list has 5 element.</p>
     ...
     * <p>Pre-Condition: The list is empty.</p>
     * <p>Post-Condition: The list has 40 elements, and the array contains them all element of list in the same order.</p>
     ...
     * the class test .</p>
     * <p>Pre-Condition: The list is empty, temp is empty.</p>
     * <p>Post-Condition: The list has 10 elements, temp is still empty.</p>
     ...
     * <p>Pre-Condition: The list is empty, coll is empty.The method used worked(add(object), clear() and addALl(Hcollection)).</p>
     * <p>Post-Condition: The list has 2 elements.</p>
     ...
     * <p>Post-Condition: List is empty. The method size() and add(Object) worked.</p>
     ...
     * <p>Pre-Condition: The list contains {1, 2, 3}. Th method size() and add(Object) worked.</p>
     ...
     * <p>Pre-Condition: List is empty.</p>
     * <p>Post-Condition: List is still empty.</p>
     * <p>Expected Results: List is empty, coll is unchanged.</p>
     */
    @Test
     ...
     * <p>Pre-Condition: List contains {1, 2, 3, 3}.</p>
     * <p>Post-Condition: List contains {1, 2, 4}.</p>
     * <p>Expected Results: list.toArray() matched with the specific array given.</p>
     */
    @Test
    ...
    /**
     * <p><b>Summary</b>: removeAll method test case.
     * The method test removeAll(Collection).</p>
     ...
     * <p>Pre-Condition: List contains the data insert. The method add(Object) and toArray() worked.</p>
     * <p>Post-Condition: List contains the remain data after method calls. coll is unchanged.</p>
     * <p>Expected Results: The element {3,4,5} are removed from list. The coll is uncahnged.</p>
     */
    @Test
    public void test_RemoveAll_From1To10DuplicatesRemove345()
    {
        for (int i = 1; i < 10; i++)
            list.add(i);
     ...
     * <p>Pre-Condition: The list is empty, and after i from 0 to 10. The method add(Object) and get(index) worked.</p>
     ...
     * <p>Test Case Design: Test the method remove from empty list.</p>
     * <p>Test Description: Try to remove null and 1 from an empty list.</p>
     * <p>Pre-Condition: List is empty and i add element from 1 to 9.</p>
    ...
    /**
     * <p><b>Summary</b>: remove and add method test case.</p>
     ...
     * <p>Pre-Condition: The list is empty.</p>
     * <p>Post-Condition: The list is not empty.</p>
     * <p>Expected Results: The composed string matches the expected string.</p>
     */
    @Test
     ...
     * <p>Pre-Condition: The list contains {1-9}. coll is null. the method add(Object) worked. </p>
     * <p>Post-Condition: The list and coll are empty.</p>
     ...
     * duplicated elements and a list containing
     * duplicated elements.. This should not change the method
     * behaviour as the absence of one element in coll removes
     * all its occurencies in the list.</p>
     ...
     * <p>Pre-Condition: List contains {0-100}. The support method worked.</p>
     * <p>Post-Condition: List contains 100 elemnet of 77.</p>
     ...
     * <p>Post-Condition: List contains 10 element.</p>
